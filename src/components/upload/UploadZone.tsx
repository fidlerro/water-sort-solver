    ...
    <div className="upload-zone">
      {!previewUrl && (
        <>
          ...
          <p className="muted">tap to upload or drag and drop</p>
          <br />
          <br />
          ...
          >
            <div style={{ display: "flex", gap: 2 }}>
              <Button
                ...
                style={{ borderRadius: "8px 0 0 8px", width: "125px" }}
              >
                Select Image
              </Button>
              <button
            ...
            {isMenuOpen && (
              ...
              >
                ...
                {[
                  { label: "7 Tubes", file: "sample-7.png" },
                  { label: "9 Tubes", file: "sample-9.png" },
                  { label: "12 Tubes", file: "sample-12.png" },
                  { label: "14 Tubes", file: "sample-14.png" },
                  { label: "16 Tubes", file: "sample-16.png" },
                ].map((sample) => (
                  <div
                    key={sample.file}
                ...
                <SegmentOverlay
                  ...
                  onSegmentColorChange={(tubeIdx, segIdx, newColor) => {
                    ...
                    if ((window as any).__handleSegmentColorChange) {
                      (window as any).__handleSegmentColorChange(
                        tubeIdx,
                        segIdx,
                        newColor,
                      );
